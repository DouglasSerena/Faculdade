...
<body id="container">
  ...
  <aside id="aside" class="bg-secondary">
    <ul class="nav-bar">
      ...
      <ul>
        <li><a href="?control=client&action=store"><i class="ri-user-add-line"></i>add</a></li>
      </ul>
      <li><a href="?control=user&action=logout"><i class="ri-logout-circle-line"></i>Logout</a></li>
    </ul>
  </aside>
