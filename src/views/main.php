...
<body>
                ...
                <div class="collapse navbar-collapse" id="nav">
                    <ul class="navbar-nav">
                        <li class="nav-item action">
                            <a class="nav-link" href="/pw2/products">Produtos</a>
                        </li>
                        <li class="nav-item action">
                            <a class="nav-link" href="/pw2/client">Lista de Usuários</a>
                        </li>
                        <li class="nav-item action">
                            <a class="nav-link" href="/pw2/about">Sobre</a>
                        </li>
                    </ul>
                </div>
            </nav>
    ...
    <footer class="fixed-bottom text-center justify-content-center align-items-center bg-dark">
        <a class="alert-link" href="/pw2/login">Admin</a>
    </footer>
